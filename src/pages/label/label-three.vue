	...
	<div>
		<el-breadcrumb separator="/">
			<el-breadcrumb-item>行业标签管理</el-breadcrumb-item>
		  	...
		  	<el-breadcrumb-item :to="{ name: 'label-two',query:{id:$route.query.lastid} }">二级标签列表</el-breadcrumb-item>
		  	<el-breadcrumb-item>三级标签列表</el-breadcrumb-item>
		</el-breadcrumb>
	    ...
	    methods:{
	    	...
	    	addlabel(){
	    		saveorupdateVocation({
	    			...
	    			double_parent_id:this.$route.query.lastid
	    		}).then((res) => {
					this.getfundlist()
					this.name = null
					swal({
